...
class TestOperations:
    ...
    @pytest.mark.parametrize('accout', ['Credit card', 'Debit card'])
    def test_user_with_operation(self, user: str, accout: str):
...
users = {
    ...
    '700000002': 'User with operations on bank account'
}
