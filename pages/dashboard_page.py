...
class DashboardPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.activity_title = page.get_by_test_id('activities-widget-title-text')
    ...
    def check_visible_activities_chart(self):
        expect(self.activity_title).to_be_visible()
        expect(self.activity_title).to_have_text('Activities')
